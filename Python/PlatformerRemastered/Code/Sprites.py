...
class Sprite(pygame.sprite.Sprite):
    def __init__(self, position, surf = pygame.Surface((TILE_SIZE, TILE_SIZE)), groups = None, z = Z_LAYERS["Main"]):
...
class AnimatedSprite(Sprite):
    def __init__(self, position, frames, groups, z = Z_LAYERS["Main"], animation_speed = ANIMATION_SPEED):
