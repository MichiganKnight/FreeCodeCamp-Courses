...
ModLanguage('EN',{
	...
	"Grandma": "Nana",
	"Grandma (short)": "Nana",//this is displayed in the building section! this lets you shorten the name if it doesn't need to show the whole thing
	"grandma": "nana",
	"grandmas": "nanas",
	"%1 grandma": [
		"%1 nana",
	...
	"[Achievement name 0]Wake and bake": "Blimey! A biscuit!",
	"[Achievement desc 0]Wake and bake": "Somehow produce <b>one whole biscuit</b> with your own two hands.",
