...
export class SpaceApiService {
  ...
  getArticlesAPI() : Observable<any>{
    return this.httpClient.get("https://api.spaceflightnewsapi.net/v4/articles");
  }
  ...
  getReportsAPI() : Observable<any>{
    return this.httpClient.get("https://api.spaceflightnewsapi.net/v4/reports");
  }
  ...
  getReportsByIdAPI(id : number) : Observable<any>{
    return this.httpClient.get("https://api.spaceflightnewsapi.net/v4/reports/"+id)
  }
}
