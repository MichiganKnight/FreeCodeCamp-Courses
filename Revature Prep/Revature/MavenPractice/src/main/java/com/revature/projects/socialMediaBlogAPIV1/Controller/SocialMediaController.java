package com.revature.projects.socialMediaBlogAPIV1.Controller;
...
import com.revature.projects.socialMediaBlogAPIV1.Service.AccountService;
import com.revature.projects.socialMediaBlogAPIV1.Service.MessageService;
...
public class SocialMediaController {
    ...
    private void sendMessage(Context ctx) throws JsonProcessingException {
        ObjectMapper mapper = new ObjectMapper();
    ...
    private void updateMessageById(Context ctx) throws JsonProcessingException {
        ...
        ObjectMapper mapper = new ObjectMapper();
        Message messageBody = mapper.readValue(ctx.body(), Message.class);
        String newMessageText = messageBody.getMessage_text();
