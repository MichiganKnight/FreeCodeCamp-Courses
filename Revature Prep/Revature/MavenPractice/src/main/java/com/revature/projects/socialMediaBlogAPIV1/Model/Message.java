package com.revature.projects.socialMediaBlogAPIV1.Model;
...
public class Message {
    ...
    public boolean equals(Object o) {
        ...
        return message_id == message.message_id && posted_by == message.posted_by && time_posted_epoch == message.time_posted_epoch && message_text.equals(message.message_text);
    }

    @Override
    public String toString() {
        return "{" + "message_id=" + message_id + ", posted_by=" + posted_by + ", message_text='" + message_text + '\'' + ", time_posted_epoch=" + time_posted_epoch + '}';
    }
}
